-- ==============================================================================
-- PETPREV — MIGRATION 001: INITIAL RELATIONAL & SPATIAL SCHEMA
-- Baseado na Seção 2 do SDD v3.0 (PostgreSQL 16 + PostGIS)
-- ==============================================================================
...
CREATE TABLE IF NOT EXISTS users (
    ...
    password_hash VARCHAR(255) NULL, -- Nullable para autenticação OTP Passwordless
...
-- 4. TABELA DE SESSÕES & REFRESH TOKENS ROTATIVOS
...
-- 5. TABELA DE LOGS DE AUDITORIA UNIFICADA
...
-- 6. TABELA DE TUTORES & GEOLOCALIZAÇÃO
...
-- 8. TABELA DE VETERINÁRIOS & CHAVE PÚBLICA ECDSA
...
-- 11. ATENDIMENTOS (VISITAS PREVENTIVAS DOMICILIARES)
...
-- 12. AUDITORIA DE CADEIA DE FRIO (TRAVA TÉRMICA 2°C A 8°C)
...
-- 13. PRONTUÁRIO ELETRÔNICO LEGALMENTE IMUTÁVEL (CFMV + ECDSA + ACEITE TUTOR)
...
-- TRIGGER FUNCTION DE IMUTABILIDADE COM REGISTRO EM AUDIT_LOGS
...
-- 14. TELEORIENTAÇÃO WEBRTC (LIVEKIT)
...
-- 15. FILA DE MENSAGENS OUTBOX WHATSAPP
...
-- 16. RECONCILIAÇÃO FINANCEIRA E REPASSES PIX
...
-- ==============================================================================
-- ÍNDICES GEOESPACIAIS (GIST), HEXAGONAIS (H3) E DE PERFORMANCE
-- ==============================================================================
